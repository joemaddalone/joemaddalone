...
<hgroup>
	<h1>Svg Path Data in Canvas</h1>
	<p>Building canvas shapes with svg path data</p>
</hgroup>
...
<canvas width="300" height="80" id="ex2" style="background: white;" class="mt3"></canvas>
...
<canvas width="300" height="80" id="ex3" style="background: white;" class="mt3"></canvas>
...
<canvas width="300" height="80" id="ex4" style="background: white;" class="mt4 mv4"></canvas>
